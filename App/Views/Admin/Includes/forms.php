...
<form method="post" id="<?php echo $id; ?>">
    ...
    <?php foreach ($fields as $field) { ?>
        ...
        <?php if (!empty($attributes) && $attributes[$field]["type"] === "textarea") { ?>
            <div class="form-group">
                <?php echo Form::Label($field, ucfirst($field) . ":") ?>
                <textarea class="form-control textarea" name="<?php echo str_replace(" ", "-", $field) ?>"> <?php echo $values[$field] ?></textarea>
            </div>
        <?php continue;
        } ?>
        <?php if (!empty($attributes) && $attributes[$field]["type"] === "submit") { ?>
            <div class="form-group">
                ...
                <input type="hidden" name="mandatory-security-field" value="<?php echo Functions::encrypt($mandatorySecurityField) ?>">

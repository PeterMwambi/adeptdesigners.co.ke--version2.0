                                 ...
                                 <?php if (count($content[$title])) { ?>
                                     <div class="col-lg-2 col-4 mt-2">
                                         ...
                                         <?php foreach ($content[$title] as $contentItem) { ?>
                                             <div>
                                                 <a class="font-sm-md text-nowrap" href="<?php echo $links[$contentItem] ?>"><?php echo $contentItem ?></a>
                                             </div>
                                         <?php } ?>
                                     </div>
                                 <?php } else { ?>
                     ...
                     <div class="col-md-4 mt-3">
                         <div class="d-flex justify-content-around">
                             <div class="">
                                 ...
                                 <p class="text-body text-center">Receive the latest news on fashion directly to your email address</p>
                         ...
                         <div class="d-flex justify-content-center">
                             <img class="img-fluid title mt-2" src="<?php echo Directories::getLocation("tools/assets/title.png") ?>">
                         </div>
                         <div class="d-flex justify-content-center">
                             <p class="lead text-center mt-2">&copy; <?php echo date("Y"); ?></p>
                         </div>
                     </div>
                 </div>
                 <div class="d-flex justify-content-center">
                     <div class="d-flex justify-content-center mt-md-n5">
                         <div>
                             <a href="javascript:void(0)"> <img src="<?php echo Config::getIcon("facebook") ?>" class="img-fluid icon-sm"></a>
                         </div>
                         <div class="ml-3">
                             <a href="javascript:void(0)"> <img src="<?php echo Config::getIcon("twitter") ?>" class="img-fluid icon-sm"></a>
                         </div>
                         <div class="ml-3">
                             <a href="javascript:void(0)"> <img src="<?php echo Config::getIcon("linkedin") ?>" class="img-fluid icon-sm"></a>
                         </div>
                         <div class="ml-3">
                             <a href="javascript:void(0)"> <img src="<?php echo Config::getIcon("youtube") ?>" class="img-fluid icon-sm"></a>
                         </div>
                         <div class="ml-3">
                             <a href="javascript:void(0)"> <img src="<?php echo Config::getIcon("instagram") ?>" class="img-fluid icon-sm"></a>
                         </div>
                     </div>
                 </div>
             </section>
